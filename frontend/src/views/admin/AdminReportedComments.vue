  ...
  <div class="admin-section">
    ...
    <div v-else class="stack">
      <div class="comment-wrapper" v-for="item in items" :key="item.id">
        <CommentBlock :comment="toComment(item)" />
        <div class="reason">
...
.comment-wrapper { width: 100%; display: flex; flex-direction: column; align-items: flex-start; gap: 10px; }
...
.reason { width: 100%; max-width: 1055px; background: var(--bg-secondary); border-radius: 20px; padding: 20px; box-shadow: 0 6px 18px rgba(0,0,0,0.18) inset; font-family: var(--font-sans); min-height: 120px; display: flex; flex-direction: column; align-items: center; justify-content: center; }
