<template>
  <div class="author-comment-block" :class="{ 'highlighted': highlighted }" :style="{ marginLeft: `${(depth || 0) * 40}px` }">
    <!-- User Info -->
...
const isOwner = computed(() => {
  ...
  console.log('AuthorCommentBlock - Comment author ID:', commentAuthorId, 'Current user ID:', userId, 'Is owner:', commentAuthorId === userId)
